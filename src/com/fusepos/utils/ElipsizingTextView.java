...
public class ElipsizingTextView extends TextView
{
	...
	public ElipsizingTextView( Context context )
	{

		super( context );
	}

	public ElipsizingTextView( Context context, AttributeSet attrs )
	{

		super( context, attrs );
	}

	public ElipsizingTextView( Context context, AttributeSet attrs, int defStyle )
	{
